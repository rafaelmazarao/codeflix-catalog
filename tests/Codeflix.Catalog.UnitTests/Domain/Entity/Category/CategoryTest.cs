...
namespace Codeflix.Catalog.UnitTests.Domain.Entity.Category
{
    ...
    public class CategoryTest
    {
        ...
        public void InstantiateErrorWhenNameIsGreaterThan255Characters()
        {
            ...
            var invalidName = String.Join(null, Enumerable.Range(1, 256).Select(_ => "a").ToList());
            Action action = () => new DomainEntity.Category(invalidName, validCategory.Description);
            action.Should().Throw<EntityValidationException>()
        ...
        public void InstantiateErrorWhenDescriptionIsGreaterThan10000Characters()
        {
            ...
            var invalidDescription = String.Join(null, Enumerable.Range(1, 10001).Select(_ => "a").ToList());
        ...
        public static IEnumerable<object[]> GetNamesWithIsLessThan3Characters(int numberOfTest = 6)
        {
